...
class GEDIconfig(object):  # at some point use pjoin throughout
    def __init__(self):
        ...
        self.home_dir = '/Users/joshlamstein/GEDI3'  # Arbitrary home directory
#        self.home_dir = '/Volumes/data/robodata/Josh/GalaxyTEMP/KS-SOD1-GEDI-1/'  # Arbitrary home directory
        self.project_stem = 'project_files'  # Folder within home where analysis files will go
        self.original_image_dir = 'GEDI_images'  # Folder within home where TIFF image files exist
        self.src_dir = '/Users/joshlamstein/GEDI3'  # Project source directory
...
#        self.multi_dirs = None
        ...
        gedi_images = True
        test_set = True # If you have a {Training/Validation} and
...
#        self.gedi_image_size = [400, 400, 3]  # Size of GEDI TIFF files.
        ...
        self.tfrecord_dir = pjoin(
            ...
            '%s_%s' % (self.experiment_image_set, self.which_dataset))
        self.tf_record_train_name = 'train.tfrecords'
        self.tf_record_val_name = 'val.tfrecords'
        ...
        # Modeling settings #
        #####################
        self.model_image_size = [224, 224, 3]  # [224, 224, 1]
